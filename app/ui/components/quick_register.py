...
from app.modules.crm import crm_service as crm_srv, RegisterParentInput, RegisterStudentDTO, RegisterStudentCommandDTO
...
")
                skip_parent = st.checkbox("Register Student Without Parent", value=False)
                ...
                if not skip_parent:
                    ...
                    p_phone, p_name, p_relation = None, None, None
            ...
            if submit:
                ...
                if not s_name:
                    ...
                    st.error("Please fill Student Full Name")
                    return

                if not skip_parent and (not p_phone or not p_name):

                    st.error("Please fill Parent required fields (*)")
                    return
                ...
                try:
                    ...
                    # 1. Find or create parent if not skipped
                    ...
                    if skip_parent:
                        ...
                        st.success(f"✅ Created new Student: **{student.full_name}** (Independent)")
