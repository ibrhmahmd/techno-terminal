...
class TestRetentionMetrics:
    ...
    def test_retention_metrics_data_structure(self, client, mock_admin_headers, override_auth):
...
class TestInstructorPerformance:
    ...
    def test_instructor_performance_empty(self, client, mock_admin_headers, override_auth):
...
class TestLevelRetentionFunnel:
    ...
    def test_level_retention_funnel_success(self, client, mock_admin_headers, override_auth):
    ...
    def test_level_retention_funnel_structure(self, client, mock_admin_headers, override_auth):
...
class TestInstructorValueMatrix:
    ...
    def test_instructor_value_matrix_success(self, client, mock_admin_headers, override_auth):
    ...
    def test_instructor_value_matrix_data_types(self, client, mock_admin_headers, override_auth):
...
class TestScheduleUtilization:
    ...
    def test_schedule_utilization_percentages(self, client, mock_admin_headers, override_auth):
...
class TestFlightRiskStudents:
    ...
    def test_flight_risk_students_success(self, client, mock_admin_headers, override_auth):
    ...
    def test_flight_risk_students_risk_scores(self, client, mock_admin_headers, override_auth):
...
class TestUserEngagement:
    ...
    def test_user_engagement_success(self, client, mock_admin_headers, override_auth):
    ...
    def test_user_engagement_default_days(self, client, mock_admin_headers, override_auth):
    ...
    def test_user_engagement_custom_days(self, client, mock_admin_headers, override_auth):
    ...
    def test_user_engagement_boundary_days(self, client, mock_admin_headers, override_auth):
    ...
    def test_user_engagement_invalid_days(self, client, mock_admin_headers, override_auth):
...
class TestRetentionCohorts:
    ...
    def test_retention_cohorts_success(self, client, mock_admin_headers, override_auth):
    ...
    def test_retention_cohorts_default_months(self, client, mock_admin_headers, override_auth):
    ...
    def test_retention_cohorts_custom_months(self, client, mock_admin_headers, override_auth):
    ...
    def test_retention_cohorts_boundary_months(self, client, mock_admin_headers, override_auth):
    ...
    def test_retention_cohorts_invalid_months(self, client, mock_admin_headers, override_auth):
