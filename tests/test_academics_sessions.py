...
class TestSessionsRead:
    ...
    def test_get_session_details_not_found(self, client, mock_admin_headers, override_auth):
...
class TestSessionsWrite:
    ...
    def test_cancel_session_not_found(self, client, mock_admin_headers, override_auth):
        ...
        response = client.post("/api/v1/academics/sessions/99999/cancel", headers=mock_admin_headers)
    ...
    def test_reactivate_session_not_found(self, client, mock_admin_headers, override_auth):
        """Test reactivating non-existent session returns 404."""
        response = client.post("/api/v1/academics/sessions/99999/reactivate", headers=mock_admin_headers)
    ...
    def test_substitute_instructor_success(self, client, mock_admin_headers, override_auth, db_session):
...
class TestSessionsEdgeCases:
    ...
    def test_add_session_past_date(self, client, mock_admin_headers, override_auth, db_session):
    ...
    def test_add_session_duplicate_date(self, client, mock_admin_headers, override_auth, db_session):
    ...
    def test_cancel_already_cancelled_session(self, client, mock_admin_headers, override_auth, db_session):
    ...
    def test_cancel_and_reactivate_workflow(self, client, mock_admin_headers, override_auth, db_session):
    ...
    def test_cancel_session_updates_attendance(self, client, mock_admin_headers, override_auth, db_session):
