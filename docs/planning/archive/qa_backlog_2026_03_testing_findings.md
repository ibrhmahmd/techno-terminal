...
| U6 | **PDF receipt** | No downloadable PDF; success message only. | Printable / downloadable **PDF receipt** (branding, receipt #, lines, totals, method, date). | B2, B6 | 5 | ✅ DONE |
...
| D3 | **Analytics / reporting views** | Course stats may need a **view** or materialized query for performance. | Add view or indexed query; document in `MEMORY_BANK`. | 3 | ✅ DONE |
