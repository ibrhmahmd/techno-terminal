-- 057: Update daily_report template — merge payments_by_type into payment_details
-- The {{payments_by_type}} placeholder is now always empty; payment grouping is
-- rendered inside {{payment_details}} as a single merged table.
...
<body>
  ...
  <p class="footer">This is an automated report from Techno Kids CRM.</p>
    ...
    variables = ARRAY['date', 'total_revenue', 'new_enrollments', 'sessions_held', 'absent_count', 'payment_count', 'payment_methods', 'attendance_rate', 'instructors_list', 'payment_details', 'session_details', 'instructor_summary']
