-- 059: Update daily_report template — remove Attendance + Outstanding Debt KPI cards
-- Keeps 3 KPIs: Total Revenue, New Enrollments, Sessions.
-- Debtors renamed to "Unpaid Students (Session 3)" — all handled by code-generated HTML.
...
<body>
  ...
  <div class="footer">
    ...
    variables = ARRAY['date', 'total_revenue', 'new_enrollments', 'sessions_held', 'payment_details', 'session_details', 'instructor_summary', 'debtors_section', 'tomorrow_preview_section']
