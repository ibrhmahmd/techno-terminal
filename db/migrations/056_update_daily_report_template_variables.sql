-- 056: Update daily_report template body with 3 new rich detail tables
-- Adds {{session_details}}, {{payments_by_type}}, {{instructor_summary}} placeholders
...
<body>
  ...
  <p class="footer">This is an automated report from Techno Kids CRM.</p>
    ...
    variables = ARRAY['date', 'total_revenue', 'new_enrollments', 'sessions_held', 'absent_count', 'payment_count', 'payment_methods', 'attendance_rate', 'unpaid_count', 'instructors_list', 'payment_details', 'session_details', 'payments_by_type', 'instructor_summary']
